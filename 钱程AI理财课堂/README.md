...
钱程是一套面向理财初学者的 AI 互动课程，不是开放式理财聊天机器人。八门课都有固定、可验证的教学主线；学习者的选择、理由、追问和老师的解释则因人而异。
...
<table>
  <tr>
    <td align="center"><img src="docs/images/portfolio/course-home.jpg" width="260" alt="课程首页与学习地图"><br><b>课程地图</b><br>八门课与单课进度一目了然</td>
...
学生可以自由追问，也可以随时主动进入下一场景；暂时不想回答的选择题会保留为待回看。八门课分别保存进度，支持退出续学和单课从头学习。
...
7. 基金和股票，到底买到了什么：底层资产、基金份额与公开规则
8. 涨跌不是信号：用时间看收益与波动：净值、期限、波动与风险承受
